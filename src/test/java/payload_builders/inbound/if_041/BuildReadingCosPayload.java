...
public class BuildReadingCosPayload extends DynamicDataGenerators {
    public JSONObject runnerObj;

    public Payload getPayload(String mpan, String gspGroupId, String meterId, String cumulativeRegisterReadings,
                              String cumulativeRegisterReadingDateTime, String readingMethod, String siteVisitCheckCode) throws IOException {
        ...
        eventCode.add(MessagesConstants.IF_041_READINGCOS);
        ...
        b064.setReadingMethod(readingMethod);
        b064.setSiteVisitCheckCode(siteVisitCheckCode);
        b064.setCumulativeRegisterReading(cumulativeRegisterReadings);
        b064.setCumulativeRegisterReadingDateTime(cumulativeRegisterReadingDateTime);
